...
<!-- Nhạc nền  -->
<audio id="player" src="{{asset('vendor/assets/a.mp3')}}"></audio> <!-- Sửa bài hát ở đây -->

<script>
    //Sửa ảnh và lời nhắn ở đây
    const messages = [
        {
            img: '{{asset('vendor/assets/anh0.jpg')}}', //Thay ảnh
            text: 'Chúc mẹ và 2 chị luôn vui vẻ, xinh đẹp và ngập tràn yêu thương!', //Thay lời nhắn
        },
        {
            img: '{{asset('vendor/assets/anh1.jpg')}}',
            text: 'Tháng Mười có ngày Hai Mươi, chúc cho phụ nữ nụ cười nở hoa.',
        },
        {
            img: '{{asset('vendor/assets/anh2.jpg')}}',
            text: 'Chúc một nửa thế giới đẹp tựa như hoa, cuộc đời an nhiên, hạnh phúc đầy nhà.',
        },
        {
            img: '{{asset('vendor/assets/anh3.jpg')}}',
            text: 'Trời đất ưu ái ngày Hai Mươi, để tôn vinh những con người tuyệt vời. ',
        },
        {
            img: '{{asset('vendor/assets/anh4.jpg')}}',
            text: 'Nơi nào có phụ nữ, nơi đó có yêu thương. Chúc mừng ngày của những yêu thương rạng ngời!',
        },
        {
            img: '{{asset('vendor/assets/anh5.jpg')}}',
            text: 'Chúc các đóa hồng luôn rạng rỡ kiêu sa, không chỉ hôm nay mà ở cả ngày qua ngày sau.',
        },
        {
            img: '{{asset('vendor/assets/anh6.jpg')}}',
            text: 'Chúc những vì sao lấp lánh nhất của thế gian một ngày 20/10 thật nhiều niềm vui và hạnh phúc.',
        },
    ]
    ...
    const letterImages = [
        '{{asset('vendor/assets/letters.png')}}',
        '{{asset('vendor/assets/q3.png')}}',
        '{{asset('vendor/assets/h1.png')}}',
        '{{asset('vendor/assets/h3.png')}}',
        '{{asset('vendor/assets/t2.png')}}',
        '{{asset('vendor/assets/t5.png')}}',
        '{{asset('vendor/assets/flower.png')}}',
        '{{asset('vendor/assets/morning-glory.png')}}',
    ]
